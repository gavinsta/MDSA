...
Let's lock down exactly what these equations are supposed to represent. For starters, $\beta$ is just a *parameter*. I think of it like **a 'consistent' value separate from the data**. 
