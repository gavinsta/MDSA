...
Let's lock down exactly what these equations are supposed to represent. For starters, $\beta$ is just a *parameter*. I think of it like it is **a 'consistent' value within the data**. 
